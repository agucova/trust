function PayoffsUI(config){
	...
	dom.appendChild(_makeLabel("label_cheat", {x:232, y:90, rotation:45, align:"center", color:"#cccccc"}));
	dom.appendChild(_makeLabel("label_cheat", {x:-7, y:82, rotation:-45, align:"center", color:"#cccccc"}));
